...
Don't forget to change `screenshot.png` and the theme meta data in `style.css`. Oh, and you should probably change the name of the `themes/startline/` directory too. :wink:
